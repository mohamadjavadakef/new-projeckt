        ...
        <section class="main-body-container">
            ...
            <section class="card mb-3">
                <section class="card-header text-white bg-custom-yellow">
                    کامران محمدی - 54848496
                </section>
                <section class="card-body ">
                    <h5 class="card-title">
                        کد کالا : appel watch 5484984968574968 مشخصات کالا : ساعت هوشمند
                    </h5>
                    <p class="card-text">به نظر من ساعت خوبیه فقط وزنش زیاده و زود شارژ تموم میکنع</p>
                </section>
            </section>
            <section>
                <form action="" method="">
